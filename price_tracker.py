"""
Bergdorf Goodman Price Tracker - Bright Data Web Scraper API
----------------------------------------------------
Track prices, availability, and product data from Bergdorf Goodman.

Docs  : https://docs.brightdata.jp/scraping-automation/web-scraper-api/overview
Info  : https://brightdata.jp/products/insights/price-tracker/bergdorf-goodman
"""
...
# Set your Web Scraper ID after building your Bergdorf Goodman scraper:
# https://brightdata.jp/products/web-scraper/bergdorf-goodman
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your Bergdorf Goodman scraper at: https://brightdata.jp/products/web-scraper/bergdorf-goodman\n"
...
def track_prices(urls: list[str], **kwargs) -> list[dict]:
    """
    Collect price data for a list of Bergdorf Goodman product URLs.
...
def discover_by_keyword(keyword: str, limit: int = 50, **kwargs) -> list[dict]:
    """
    Discover Bergdorf Goodman products by keyword search.
...
def discover_by_category(category_url: str, limit: int = 100, **kwargs) -> list[dict]:
    """
    Discover all products from a Bergdorf Goodman category page.

    Example:
        results = discover_by_category("https://bergdorfgoodman.com/s?k=headphones", limit=200)
    """
...
if __name__ == "__main__":
    ...
    sample_urls = [
        "https://www.bergdorfgoodman.com/en/products/sample-product-123456",
        # Add more Bergdorf Goodman product URLs here
    ]
    results = track_prices(sample_urls)

    output_file = "bergdorf-goodman_prices.json"
    ...
    # cat_results = discover_by_category("https://bergdorfgoodman.com/category/sample", limit=50)
